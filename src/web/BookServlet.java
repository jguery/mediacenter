...
import exceptions.MediaAvailableException;
...
public class BookServlet extends HttpServlet {
    ...
    catch (MediaAvailableException e)
    {
    	this.getServletContext().setAttribute("badExecution", "The media is already available in the library, no need to book it.");
			request.getRequestDispatcher("book.jsp").forward(request, response);
			e.printStackTrace();
			return;
    }
