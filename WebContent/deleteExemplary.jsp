...
<title>Delete an exemplary of a media</title>
</head>
<body>
...
<p>Fill this form to delete an exemplary of a media:</p>

<form action="deleteExemplary.do" method="post">
<table>
    <tr>
...
<input type="submit" value="Delete exemplary">
</form>
