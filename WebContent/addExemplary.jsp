...
<title>Add an exemplary to a media</title>
</head>
<body>
...
<p>Fill this form to add an exemplary to a media:</p>

<form action="addExemplary.do" method="post">
<table>
    <tr>
...
<input type="submit" value="Add exemplary">
</form>
